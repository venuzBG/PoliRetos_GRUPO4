...
public class TroyaCarlos {
    ...
    private int ctTamanio;
    private Character ctChar;
    private int ctNivel;

    public int getCtNivel() {
        return ctNivel;
    }

    public void setCtNivel(int ctNivel) {
     ...
     * @param ctTamanio: es el objeto tipo Entero que dara valor al tamanio de las figuras
     * @param ctChar: es el objeto tipo Character con el que se personalizara cierta figuras
     */
    // public TroyaCarlos(int ctTamanio, Character ctChar) {
    //     setCtChar(ctChar);
    //     setCtTamanio(ctTamanio);
    // }
    /**
     * Getter que entrega para el tamanio de las figuras
     * @return Devuelve el int con el valor del tamanio para las figuras 
     */
    public int getCtTamanio() {
        return ctTamanio;
    }
    /**
     * Setter que modifica para el tamanio de las figuras y solo admite valores superiores o igual a 1.
     * @param ctTamanio: es el objeto tipo Entero que ingresamos para tamanio de las figuras
     */
    public void setCtTamanio(int ctTamanio) {
     ...
     * @param ctChar: es el parametro Caracter que ingresamos para personalizar ciertas figuras
     */
    ...
    /**
     * Este metodo rotula la figura F15 que es la piramide de Pascal alineada hacia la derecha.
     * @param ctTamanio: Es el parametro entero que da el tamaño de la figura o numero de filas que deseamos visualizar.
     */
    ...
    /**
     * Este metodo rotula la figura F14 que es la piramide de Pascal, distribuida en cascada o en el centro.
     * @param ctTamanio: es el tamanio o numero de filas que se desea visualizar de la piramide.
     */
     ...
     * @param ctTamanio: Es el entero que da el tamanio o numero de filas que se desea ver de la piramide.
     */
    ...
    /**
     * Este metodo rotula la figura F12 que es una piramide invertida alineada a la derecha
     * que en cada nivel tiene numeros en secuencia del 1 al 9.
     * @param ctTamanio: Es el entero que da valor al tamanio o numero de filas que se desea visualizar de la piramide.
     */
    ...
    /**
     * Este metodo rotula una escale que cada vez que desciende de nivel, cada escalon tiene un caracter mas de longitud
    ...
    /**
     * Este metodo rotula la figura F10 que es una escalera que en cada escalon que desciende,
     *  se alterna un caracter entre + y -
     * @param ctTamanio: Es en entero que representa el tamanio de la escalera o numero de escalones que se desea visualizar
     * @param ctChar: Es el caracter con el que se pueden personalizar los escalones.
     */
    ...
    /**
     * Este metodo rotula la figura F9 que es una piramide centrada en la mitad y conformada por escalones
     * @param ctTamanio: es el entero que da valor al tamanio de la piramide o numero de niveles que se desean visualizar
     * @param ctChar: es el caracter con el que se puede personalizar los escalones de la piramide.
     */
